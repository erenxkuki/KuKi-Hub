...
-- Your logo ID
_G.Logo = 90981445742149
_G.Logo1 = 90981445742149
...
LogoImage.Position = UDim2.new(0.02, 0, 0.02, 0)
LogoImage.Size = UDim2.new(0, 30, 0, 30)
LogoImage.Image = "rbxassetid://90981445742149"
...
Title.Position = UDim2.new(0.12, 0, 0.04, 0) -- Adjusted for logo
Title.Size = UDim2.new(0, 483, 0, 31)
Title.Font = Enum.Font.GothamBold
Title.Text = "KuKi".."<font color='rgb(255, 0, 0)'> Hub</font>".." | "..game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name -- Red text
Title.RichText = true;
...
Menu_Setting.Position = UDim2.new(0, 480, 0, 7)
...
UIGradient.Color = ColorSequence.new {
  ...
  ColorSequenceKeypoint.new(0.29, Color3.fromRGB(255, 0, 0)), -- Red
  ColorSequenceKeypoint.new(0.50, Color3.fromRGB(255, 0, 0)), -- Red
  ColorSequenceKeypoint.new(0.68, Color3.fromRGB(200, 0, 0)), -- Dark red
...
UIGradient2.Color = ColorSequence.new {
  ColorSequenceKeypoint.new(0.00, Color3.fromRGB(29, 29, 29)), ColorSequenceKeypoint.new(1.00, Color3.fromRGB(29, 29, 29))}
...
UiToggle_UiStroke901.Color = _G.Color -- Red
...
Label22.BackgroundColor3 = _G.Color -- Red
...
Label23.BackgroundColor3 = _G.Color -- Red
...
Text.BackgroundColor3 = _G.Color -- Red
...
Button_2.BackgroundColor3 = Color3.fromRGB(33, 132, 112)
  ...
  Button_2.BackgroundColor3 = _G.Color -- Red
end
...
TweenService:Create(
  ...
  TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
  {
    BackgroundColor3 = state and Color3.fromRGB(33, 132, 112) or _G.Color -- Red
  }
):Play()
callback(state)
Tgs = state
...
-- Red stroke
local UiToggle_UiStrokeToggle = Instance.new("UIStroke")
UiToggle_UiStrokeToggle.Color = _G.Color -- Red
UiToggle_UiStrokeToggle.Thickness = 1
UiToggle_UiStrokeToggle.Name = "UiToggle_UiStrokeToggle"
UiToggle_UiStrokeToggle.Parent = MainToggle
...
if default == true then
	MainToggle_3.BackgroundColor3 = _G.Color -- Red
...
MainValue.BackgroundColor3 = _G.Color -- Red
...
ConneValue.BackgroundColor3 = _G.Color -- Red
