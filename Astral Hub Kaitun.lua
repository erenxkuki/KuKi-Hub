...
local function GetQuestData()
    ...
    local TeamSelf = "Pirates"
    pcall(function()
        TeamSelf = game.Players.LocalPlayer.Team and game.Players.LocalPlayer.Team.Name or "Pirates"
    end)
    
    local Mon, Qname, Qdata, NameMon, PosQ, PosM, Entrance
    local World1 = (game.PlaceId == 2753915549)
    local World2 = (game.PlaceId == 4442274628)
    ...
    if not PosQ then PosQ = CFrame.new(0, 0, 0) end
    PosM = PosQ
...
task.spawn(function()
    while task.wait(0.5) do
        ...
        pcall(function()
            ...
            UpdateStatus("Leveling: " .. (questData and questData.NameMon or "Waiting..."            -- Only farm if questData exists
     if questData then
