...
-- ██████ RED THEME ██████
_G.Color = Color3.fromRGB(255, 0, 0)   -- Pure Red
...
function library:Make()
    ...
    HeaderTop.BackgroundColor3 = Color3.fromRGB(20, 20, 20)  -- Darker black
    ...
    Title.Size = UDim2.new(0, 440, 0, 31)
    Title.Font = Enum.Font.GothamBold
    -- ██████ KUKI HUB TITLE ██████
    Title.Text = "KuKi" .. "<font color='rgb(255, 0, 0)'> Hub</font>" .. " | " .. game:GetService("MarketplaceService"):GetProductInfo(game.PlaceId).Name
    Title.RichText = true
    ...
    -- ██████ CUBE TOGGLE BUTTON (Open/Close GUI) ██████
    local CubeToggle = Instance.new("ImageButton")
    CubeToggle.Name = "CubeToggle"
    CubeToggle.Parent = HeaderTop
    CubeToggle.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
    CubeToggle.BackgroundTransparency = 1
    CubeToggle.Position = UDim2.new(1, -60, 0.5, -12)
    CubeToggle.Size = UDim2.new(0, 24, 0, 24)
    CubeToggle.Image = "rbxassetid://7481529843"  -- Cube icon
    CubeToggle.ImageColor3 = Color3.fromRGB(255, 255, 255)
    CubeToggle.ZIndex = 10
    CubeToggle.AutoButtonColor = false

    local CubeStroke = Instance.new("UIStroke")
    CubeStroke.Color = _G.Color
    CubeStroke.Thickness = 1.5
    CubeStroke.Transparency = 0.3
    CubeStroke.Parent = CubeToggle

    local CubeCorner = Instance.new("UICorner")
    CubeCorner.CornerRadius = UDim.new(0, 4)
    CubeCorner.Parent = CubeToggle

    CubeToggle.MouseButton1Click:Connect(function()
        CircleClick(CubeToggle, Mouse.X, Mouse.Y)
        if uitoggled == false then
            Main:TweenSize(UDim2.new(0, 0, 0, 0), Enum.EasingDirection.Out, Enum.EasingStyle.Quart, 0.8, true)
            uitoggled = true
            wait(0.1)
            UI.Enabled = false
        else
    ...
    -- Optional settings gear (kept but moved left)
    ...
    Menu_Setting.Position = UDim2.new(1, -30, 0.5, -12)
    ...
    Menu_Setting.MouseButton1Click:Connect(function()
        CircleClick(Menu_Setting, Mouse.X, Mouse.Y)
    ...
    function tabs:Tab(Name, icon)
        ...
        local function GetType(value)
            if value == 1 then return Left elseif value == 2 then return Right else return Left end
        end
        ...
        function sections:CraftPage(side)
            ...
            Section.BackgroundColor3 = Color3.fromRGB(25, 25, 25)  -- Blackish
            ...
            function functionitem:Section(text)
                local azu = {}
                local azure = Instance.new("Frame")
                local Text = Instance.new("TextLabel")
                azure.Name = "Label"
                azure.Parent = SectionContainer
                azure.AnchorPoint = Vector2.new(0.5, 0.5)
            ...
            function functionitem:ButtonTog(Title, default, callback)
                ...
                Button_2.BackgroundColor3 = default and _G.Color or Color3.fromRGB(40, 40, 40)
                ...
                function b3Func:Update(state)
                    TweenService:Create(
                        Button_2,
                        TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                        { BackgroundColor3 = state and _G.Color or Color3.fromRGB(40, 40, 40) }
                    ):Play()
                    callback(state)
                    Tgs = state
                end
            ...
            function functionitem:Button(Name, callback)
                ...
                TextButton.MouseLeave:Connect(function()
                    TweenService:Create(Button, TweenInfo.new(0.3,Enum.EasingStyle.Quad,Enum.EasingDirection.Out), { BackgroundTransparency = 0 }):Play()
                end)

                TextButton.MouseButton1Click:Connect(function()
                    CircleClick(Button, Mouse.X, Mouse.Y)
                    TextLabel_3.TextSize = 0
                    TweenService:Create(TextLabel_3, TweenInfo.new(0.4,Enum.EasingStyle.Quad,Enum.EasingDirection.Out), { TextSize = 12 }):Play()
                    callback()
                end)
            end
            ...
            function functionitem:Textbox(Name, Placeholder, callback)
                ...
                HeadTitle.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
            ...
            function functionitem:MultiDropdown(Name, list, default, callback)
                ...
                MainDropDown_2.BackgroundColor3 = Color3.fromRGB(30, 30, 30)
            ...
            function functionitem:Slider(text,floor,min,max,de,callback)
                ...
                CustomValue.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                ...
                PartValue.BackgroundColor3 = Color3.fromRGB(20, 20, 20)
                ...
                ConneValue.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = true end end)
                ConneValue.InputEnded:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = false end end)
                ...
                ValueFrame.InputBegan:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = true end end)
                ValueFrame.InputEnded:Connect(function(input) if input.UserInputType == Enum.UserInputType.MouseButton1 then dragging = false end end)
                ...
                CustomValue.FocusLost:Connect(function()
                    if CustomValue.Text == "" then CustomValue.Text = de end
                    if tonumber(CustomValue.Text) > max then CustomValue.Text = max end
